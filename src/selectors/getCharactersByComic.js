...
export const getCharactersByComic = (comic= '') => {
    if(comic === '') {
        return []
    }

    comic = comic.toLocaleLowerCase()

    return characters.filter(character => character.name.toLocaleLowerCase().includes(comic))
}